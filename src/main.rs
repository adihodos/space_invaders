...
fn main() {
    ...
    use std::ffi::CString;
    let vert_shader =
        render_gl::Shader::from_vert_source(&CString::new(include_str!("render.vert")).unwrap())
            .unwrap();

    let frag_shader =
        render_gl::Shader::from_frag_source(&CString::new(include_str!("render.frag")).unwrap())
            .unwrap();
    ...
    while !window.should_close() {
        ...
        let (fb_scale_x, fb_scale_y) = (dpy_w as f32 / wnd_w as f32, dpy_h as f32 / wnd_h as f32);
        ...
        unsafe {
            ...
            buff_draw_commands.iter().for_each(|cmd| {
                ...
                gl::Scissor(
                    ...
                    ((wnd_h as f32 - (cmd.clip_rect.y + cmd.clip_rect.h)) * fb_scale_y) as GLint,
