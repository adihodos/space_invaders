...
pub type FT_Stream_IoFunc =
  extern "C" fn(FT_Stream, c_ulong, *mut c_uchar, c_ulong) -> c_ulong;
...
pub type FT_Realloc_Func =
  extern "C" fn(FT_Memory, c_long, c_long, *mut c_void) -> *mut c_void;
pub type FT_SpanFunc = extern "C" fn(c_int, c_int, *const FT_Span, *mut c_void);
...
pub const FT_LOAD_TARGET_NORMAL: FT_Int32 =
  (FT_RENDER_MODE_NORMAL << 16) as FT_Int32;
pub const FT_LOAD_TARGET_LIGHT: FT_Int32 =
  (FT_RENDER_MODE_LIGHT << 16) as FT_Int32;
pub const FT_LOAD_TARGET_MONO: FT_Int32 =
  (FT_RENDER_MODE_MONO << 16) as FT_Int32;
pub const FT_LOAD_TARGET_LCD: FT_Int32 = (FT_RENDER_MODE_LCD << 16) as FT_Int32;
pub const FT_LOAD_TARGET_LCD_V: FT_Int32 =
  (FT_RENDER_MODE_LCD_V << 16) as FT_Int32;
...
extern "C" {
  ...
  pub fn FT_Attach_File(face: FT_Face, filepathname: *const c_char)
    -> FT_Error;
  pub fn FT_Attach_Stream(
    face: FT_Face,
  ...
  pub fn FT_Outline_GetInsideBorder(
    outline: *mut FT_Outline,
  ) -> FT_StrokerBorder;
  pub fn FT_Outline_GetOutsideBorder(
    outline: *mut FT_Outline,
  ) -> FT_StrokerBorder;
  ...
  pub fn FT_Stroker_New(
    library: FT_Library,
    stroker: *mut FT_Stroker,
  ) -> FT_Error;
  ...
  pub fn FT_Stroker_LineTo(stroker: FT_Stroker, to: *mut FT_Vector)
    -> FT_Error;
